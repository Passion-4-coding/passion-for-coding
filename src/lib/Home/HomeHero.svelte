<script lang="ts">
  ...
  import { getSelectedLanguage, useTranslations } from "$lib/translations";
...
<div class="container">
  <div class="left">
    <h1>
      {@html t('title')}
      <span class="subtext">{t("in")} <img src="/images/discord.png" alt="discord"></span>
    </h1>
